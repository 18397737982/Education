          ...
          <div class="form-group">
                ...
                <div class="col-md-8 controls">
                  ...
                  <input type="text" id="howzhi_tags" name="howzhi_customTags" required="required" class="form-control" value="" data-explain="将会应用于按标签搜索课程、相关课程的提取等" data-widget-cid="widget-3">
        			...
        			<c:otherwise>
                  <input type="text" id="howzhi_tags" name="howzhi_customTags" required="required" class="form-control" value="${courseting}" data-explain="将会应用于按标签搜索课程、相关课程的提取等" data-widget-cid="widget-3">
        			</c:otherwise>
			 	</c:choose>
