...
<script>
	//加载验证码
	function loadimage() {
		document.getElementById("randImage").src = "back/manager/img.jsp?"
				+ Math.random();
	}
	function shuaxin() {
		loadimage();
	...
	function InputYZcode() {
		...
		if (yzm.length == 4) {
			$.post("back/manager/CheckYZcode.jsp", {
				"yzm" : yzm
			}, function(data) {
				if (data > 0) {
					flag = true;
						...
						<form action="" name="loginform" accept-charset="utf-8"
							...
							<div class="uinArea" id="uinArea">
								...
								<div class="inputOuter" id="uArea">
									...
									<input type="text" id="aname" name="aname" class="inputstyle" /><span
										id="msg"></span>
								</div>
							</div>
							<div class="pwdArea" id="pwdArea">
								...
								<div class="inputOuter" id="pArea">
									...
									<input type="password" id="apassword" name="apassword"
										class="inputstyle" /><span id="msg02"></span>
								</div>
							</div>
							<div style="width: 310px;">
								<label style="font-size: 16px; margin-top: 20px; float: left;">验证码：</label>
								<input class="Captcha" name="YZcodeInput"
									style="height: 25px; width: 80px; float: left; margin-top: 20px;"
									placeholder="请输入验证码！" onblur="InputYZcode()" id="YZcodeInput" />
								<img alt="加载失败" name="randImage" id="randImage"
									src="back/manager/img.jsp"
									style="margin-left: 10px; float: left; width: 80px; height: 40px; margin-top: 10px;"
									border="1" onclick="shuaxin()"> <a
									href="javascript:loadimage();"
									style="margin-left: 5px; margin-top: 35px; float: left;">点击刷新</a>
							</div>
							<div id="clear" style="padding-left: 50px; margin-top: 100px;">
								<input type="button" value="登 录" style="width: 150px;"
									class="button_blue" onclick="loginadmin()" />
							</div>
					...
					<ul class="reg_form" id="reg-ul">
						...
						<li><label for="user" class="input-tips2">用户名：</label>
							<div class="inputOuter2">
								<input type="text" id="user" name="user" maxlength="30"
									class="inputstyle1" value="" /><span id="tishi1"></span>
							</div></li>

						<li><label for="passwd" class="input-tips2">密码：</label>
							<div class="inputOuter2">
								<input type="password" id="passwd" name="passwd" maxlength="16"
									class="inputstyle2" /><span id="tishi2"></span>
							</div></li>
						<li><label for="passwd2" class="input-tips2">确认密码：</label>
							<div class="inputOuter2">
								<input type="password" id="passwd2" name="" maxlength="16"
									class="inputstyle3" /><span id="tishi3"></span>
							</div></li>

						<li><label for="qq" class="input-tips2">QQ邮箱：</label>
							<div class="inputOuter2">

								<input type="text" id="qq" name="qq" maxlength="30"
									class="inputstyle4" />
							</div></li>

						<li>
							<div class="inputArea">
								<input type="button" id="reg" onclick="register()"
									style="margin-top: 10px; margin-left: 85px;"
									class="button_blue" value="同意协议并注册" /> <a
									href="javascript:void(0)" class="zcxy">注册协议</a>
							</div>
